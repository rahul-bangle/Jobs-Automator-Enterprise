...
async def get_demo_job(job_id: str, db: AsyncSession = Depends(get_session)):
...
async def optimize_demo(payload: Dict, db: AsyncSession = Depends(get_session)):
    ...
    base_resume = {
        "basics": {
            ...
            "summary": "Experienced professional looking for growth."
        },
        "sections": {
            "experience": "Led automation and product initiatives.",
            "skills": ["Python", "Product Strategy", "AI Tools"]
        }
    }
